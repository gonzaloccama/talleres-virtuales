...
class Pagination_Bootstrap {
	...
	private function _layout_bootstrap(){
		...
		$config['full_tag_open'] = '<ul class="pagination pg-darkgrey flex-center">';
		$config['full_tag_close'] = '</ul>';
		$config['cur_tag_open'] ='<li class="page-item active disabled"><a class="page-link text-white" href="#" tabindex="-1">';
		$config['num_tag_open'] =
