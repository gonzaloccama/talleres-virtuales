...
<section>
	...
	<div class="container">
		...
		<div class="border black-border p-5 px-4 px-lg-5">
			...
			<div class="row pt-5">
				...
				<section class="my-5">
					...
					<!-- Section heading -->
					<h2 class="h1-responsive font-weight-bold text-center">Contactamos</h2>
					<!-- Section description -->
						...
						<div class="col-md-9 mb-md-0 mb-5">
							...
							<form>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="md-form">
											<textarea id="contact-message" class="form-control md-textarea"
													  rows="3"></textarea>
